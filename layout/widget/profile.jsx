...
class Profile extends Component {
                    ...
                    .map((link) => {
                        return (
                            <a
                                ...
                                target="_blank"
                                rel={link.rel ? `noopener ${link.rel}` : "noopener"}
                                title={link.name}
                                href={link.url}
                            >
    ...
    render() {
        ...
        return (
            <div class="card widget h-card" data-type="profile">
                <div class="card-content">
                    <nav class="level">
                        <div class="level-item has-text-centered flex-shrink-1">
                            <div>
                                <figure class="image is-128x128 mx-auto mb-2">
                                    <a rel="me" href={siteUrl} class="u-url u-uid">
                                        <img
                                            class={"avatar u-photo" + (avatarRounded ? " is-rounded" : "")}
                                            src={avatar}
                                            alt={author}
                                        />
                                    </a>
                                ...
                                {author ? (
                                    <p class="title is-size-4 is-block p-name" style={{ "line-height": "inherit" }}>
                                        {author}
                                    </p>
                                ) : null}
                                {authorTitle ? <p class="is-size-6 is-block p-note">{authorTitle}</p> : null}
                                {location ? (
                                    <p class="is-size-6 is-flex justify-content-center p-locality">
