                    ...
                    >
                                    ...
                                    {page.date && (
                                        <span
                                            ...
                                            dangerouslySetInnerHTML={{
                                                __html: _p(
                                                    "article.created_at",
                                                    `<time class="dt-published"  datetime="${moment
                                                        .utc(page.date)
                                                        .format("YYYY-MM-DD HH:mm:ss")}" title="${moment
                                                        .utc(page.date)
                                                        .format("YYYY-MM-DD HH:mm:ss")}">${date(page.date)}</time>`
                                                ),
                                            }}
                                        ></span>
                                    )}
                                            ...
                                            dangerouslySetInnerHTML={{
                                                __html: _p(
                                                    ...
                                                    `<time datetime="${moment
                                                        ...
                                                        .format("YYYY-MM-DD HH:mm:ss")}" title="${moment
                                                        .utc(page.updated)
                                                        .format("YYYY-MM-DD HH:mm:ss")}">${date(page.updated)}</time>`
                                                ),
                                            }}
                                        ></span>
                                    )}
                                        ...
                                        <span class="level-item">
                                            {(() => {
                                                ...
                                                page.categories.forEach((category, i) => {
                                                    categories.push(
                                                        <a class="link-muted p-category" href={url_for(category.path)}>
                                                            {category.name}
                                                        </a>
                                                    );
                        ...
                        {page.title !== "" && index ? (
                            <p class="title is-3 is-size-4-mobile">
                                <a class="link-muted p-name u-url" href={url_for(page.link || page.path)}>
                                    {page.title}
                                </a>
                            </p>
                        ) : null}
